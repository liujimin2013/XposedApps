...
public class Constants {
    ...
    public static final String ALIPAY_TRADE_DETAIL_ACTIVITY_ = "com.alipay.mobile.bill.detail.ui.TradeDetailActivity_";
    public static final String ALIPAY_TRADE_DETAIL_ACTIVITY = "com.alipay.mobile.bill.detail.ui.TradeDetailActivity";
    ...
    public static final String ALIPAY_BILLLIST_ACTIVITY_ = "com.alipay.mobile.bill.list.ui.BillListActivity_";
    public static final String ALIPAY_BILLLIST_ACTIVITY = "com.alipay.mobile.bill.list.ui.BillListActivity";

    public static final String ALIPAY_MESSAGEBOX_ACTIVITY  = "com.alipay.android.phone.messageboxapp.ui.MsgboxAppActivity";

    public static final String SMARTDIALER_PACKAGENAME = "com.bitstunnel.smartdialer.app.release";

    public static final String SMARTDIALER_MAINACTIVITY = "com.bitstunnel.smartdialer.app.CommandBoardActivity";
